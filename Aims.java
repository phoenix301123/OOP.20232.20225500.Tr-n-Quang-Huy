...
public class Aims {
    ...
    public static void initSetup() {
        ...
        Book book = new Book("S", 20.00f);
        Book book1 = new Book("W", "Biography", 202.00f);
        Book book2 = new Book("Q", "Science", 120.00f);
        store.addMedia(book);
        ...
        Track track1CD1 = new Track("X", 161);
        Track track2CD1 = new Track("Y", 403);
        Track track3CD1 = new Track("Z", 300);
        ...
        Track track1CD2 = new Track("D", 180+34);
        Track track2CD2 = new Track("E", 180+30);
        Track track3CD2 = new Track("F", 60*2+39);
        cd2.addTrack(track1CD2);
        cd2.addTrack(track2CD2);
        cd2.addTrack(track3CD2);

        CompactDisc cd3 = new CompactDisc("A", "Music","Justin Bieber", 1000.98f);
        Track track1CD3 = new Track("B", 4*60+5);
        Track track2CD3 = new Track("C", 4*60+35);
